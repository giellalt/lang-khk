...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_khk to login script."
...
# the current dir:
if   test x${GTLANG_khk} = x ; then
	echo "WARNING: The variable \${GTLANG_khk} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_khk} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_khk} has the value:"
	echo "  ${GTLANG_khk}"
